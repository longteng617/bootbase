...
var prefix = "/bootbase/common/sysDict";
$(function() {
	load();
});
function selectLoad() {
	var html = "";
	$.ajax({
		url : '/bootbase/common/sysDict/type',
				...
				columns : [
					...
					},
					{
						...
						formatter : function(value, row, index) {
							...
							var f = '<a class="btn btn-success btn-sm ' + s_add_h + '" href="#" title="添加"  mce_href="#" onclick="addD(\''
...
function resetForm(){
	document.getElementById("searchDict").reset(); 
}
