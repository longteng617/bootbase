var prefix = "/bootbase/activiti/process"
$(function() {
	load();
});
				...
				columns : [
...

                    {
						...
						formatter:function (value,row,index) {
                            var e = '<a   href="/bootbase/activiti/process/resource/read/xml/'+row.id+'"  title="xml" target="_blank">xml</a> ';
                            return e;
                        }
                    },
                    {
                        ...
                        title : '流程XML',
                        formatter:function (value,row,index) {
                            var e = '<a   href="/bootbase/activiti/process/resource/read/image/'+row.id+'"  title="图片" target="_blank">图片</a> ';
                            return e;
                        }
                    },
					{
