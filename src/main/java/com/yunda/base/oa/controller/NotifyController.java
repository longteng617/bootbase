...
import com.yunda.base.common.domain.DictDO;
...
import com.yunda.base.oa.service.NotifyRecordService;
...
public class NotifyController extends BaseController {
	...
	public PageUtils list(@RequestParam Map<String, Object> params) {
		...
		List<NotifyDO> notifyList = notifyService.listNotify(query);
	...
	public R save(NotifyDO notify) {
		notify.setId(MajorKey.getKeyID());
