...
import com.yunda.base.common.utils.FileType;
import com.yunda.base.common.utils.FileUtil;
...
public class FileController extends BaseController {
	...
	public R remove(Long id, HttpServletRequest request) {
		...
		String fileName = autoBaseConfig.getUploadPath() + sysFileService.get(id).getUrl().replace("/files/", "");
	...
	R upload(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
		...
		try {
			FileUtil.uploadFile(file.getBytes(), autoBaseConfig.getUploadPath(), fileName);
		} catch (Exception e) {
			return R.error();
		}
