package com.yunda.base.activiti.controller;
...
import com.yunda.base.activiti.service.ActTaskService;
import com.yunda.base.activiti.vo.ProcessVO;
import com.yunda.base.activiti.vo.TaskVO;
...
public class TaskController {
	...
	PageUtils list(int offset, int limit) {
		List<ProcessDefinition> processDefinitions =
				repositoryService.createProcessDefinitionQuery().listPage(offset, limit);
	...
	public void startForm(@PathVariable("procDefId") String procDefId, HttpServletResponse response)
		...
		response.sendRedirect("/bootbase" + formKey);
	}
	...
	public void form(@PathVariable("procDefId") String procDefId, @PathVariable("taskId") String taskId,
		...
		response.sendRedirect("/bootbase" + formKey + "/" + taskId);
	}
